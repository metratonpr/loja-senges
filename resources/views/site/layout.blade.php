...
<body>
        ...
        <nav class="grey darken-3">
            <div class="nav-wrapper container">
                ...
                <ul id="nav-mobile" class="left">
                    ...
                    <li><a href="{{route('site.carrinho')}}">Carrinho <span class="new badge orange">{{\Cart::getContent()->count()}}</span></a></li>
    ...
    <ul id='dropdown1' class='dropdown-content'>
      ...
      <li class="grey darken-3"><a href="{{route('site.categoria', $categoria->id )}}" class="white-text">{{$categoria->nome}}</a></li>
      @endforeach
